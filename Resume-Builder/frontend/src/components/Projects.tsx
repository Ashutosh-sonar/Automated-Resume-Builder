...
const Projects = () => {
  ...
  const onSubmit = async (values: any, onSubmitProps: any) => {
    try {
      if (isEdit) {
        await axios.put('/api/projects', { project: values.project });
        toast.success(' Details Updated Successfully');
      } else {
        await axios.post('/api/projects', { project: values.project });
  ...
  const handleDelete = async (formik: any, index: any) => {
    try {
      ...
      await axios.delete(`/api/project/${projectToDelete._id}`);
