...
const Experience = () => {
  ...
  const onSubmit = async (values: any, onSubmitProps: any) => {
    try {
      if (isEdit) {
        await axios.put("/api/experience", { experiences: values.experiences });
        toast.success(" Details Updated Successfully");
      } else {
        toast.success("Details Saved Successfully");
        await axios.post("/api/experience", { experiences: values.experiences });
  ...
  const handleDelete = async (formik: any, index: any) => {
    try {
      ...
      await axios.delete(`/api/experience/${experienceToDelete._id}`);
